...
file_path3 = 'Data/flattened_images_removed_ball_with_indices_small.pkl'  # Replace with the path to your third file

# Combine the data from three files
combined_data = combine_data(file_path1, file_path2, file_path3)

# Save the combined data
with open('Data/combined3_flattened_data_with_indices.pkl', 'wb') as file:
